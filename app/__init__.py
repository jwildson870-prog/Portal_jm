...
def create_app(test_config=None):
    ...
    app.config.update(SECRET_KEY=os.getenv('SECRET_KEY','dev-change-me'),SQLALCHEMY_DATABASE_URI=dburl,SQLALCHEMY_TRACK_MODIFICATIONS=False,UPLOAD_FOLDER=os.getenv('UPLOAD_FOLDER', str(Path(app.root_path).parent/'uploads')),MAX_CONTENT_LENGTH=25*1024*1024,SESSION_COOKIE_HTTPONLY=True,SESSION_COOKIE_SAMESITE='Lax',SESSION_COOKIE_SECURE=os.getenv('SESSION_COOKIE_SECURE','false').lower()=='true')
